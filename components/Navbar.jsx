...
const Navbar = () => {
  ...
  const [linkColor, setLinkColor] = useState('#f1f5f9');
  ...
  return (
    ...
    >
      <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className='rounded-full hidden md:flex pr-4'>
      ...
      <div
        className={
          nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70 text-white' : ''
        }
      >
        {/* Side Drawer Menu */}
        <div
        ...
        >
          <div>
            ...
            <div className='border-b border-gray-900 my-20'>
              <p className='w-[85%] md:w-[90%] py-7'>
          ...
          <div className='py-4 flex flex-col'>
            ...
            <div className='pt-40'>
              <p className='uppercase tracking-widest text-[#ff3535]'>
                Let&#39;s Connect
              </p>
